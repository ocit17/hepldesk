	...
	<ul class="nav menu">
		...
		<?php if ($this->session->userdata('level') == "ADMIN") { ?>
			...
			<li><a href="<?php echo base_url(); ?>approval/approval_list"><svg class="glyph stroked email">
					...
					<use xlink:href="#stroked-male-user"></use></svg> Aprroval Ticket (<?php if (empty($notif_approval)) {
																							echo "0";
																						} else {
																							echo $notif_approval;
																						} ?>)
...
<li><a href="<?php echo base_url(); ?>teknisi/teknisi_list"><svg class="glyph stroked calendar"><use xlink:href="#stroked-male-user"></use></svg> Teknisi</a></li> -->
			...
			<li><a href="<?php echo base_url(); ?>dashboard_teknisi/report_bulanan"><svg class="glyph stroked report">
						<use xlink:href="#stroked-notepad"></use>
					</svg> Report Bulanan</a></li>
